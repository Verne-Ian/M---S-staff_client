...
class OldAppoint extends StatefulWidget {
  final String where;
  const OldAppoint({super.key, required this.where});

  @override
  State<OldAppoint> createState() => _OldAppointState();
}

class _OldAppointState extends State<OldAppoint> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: StreamBuilder<QuerySnapshot>(
          stream: firestore
              .collection('appointments')
              .where('service', isEqualTo: widget.where)
